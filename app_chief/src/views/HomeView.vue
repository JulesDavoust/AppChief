<template>
  <HeaderView Userpp="DefaultUser.jpg"/>
<div class="home">
  <div id="bann" :style="{backgroundImage: `url(${Image})`}">
  ...
  <div class="bestOfChief">
    <container >
      <chief-card-home-page  v-for="item in listOfBestChiefs" verif="1" cp="heart.png" :key="item" :email=item.email :AvGrade=item.grade :ChiefFN=item.firstName :ChiefLN=item.lastName :Description=item.description :dispo=item.dispo></chief-card-home-page>
...
import ChiefCardHomePage from '@/components/ChiefCardHome.vue'
